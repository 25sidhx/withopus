...
SKIP_DIRS = {
    ...
    '.agent', '.shared', 'antigravity-kit-main', 'antigravity-skills',
    'antigravity-skills-main', 'spikes', 'agency-agents-', 'opus-autopilot',
    'test_post', 'leads', '.planning', 'claude code', '.netlify'
}
...
def find_pages(project_path: Path) -> list:
    ...
    for pattern in patterns:
        for f in project_path.glob(pattern):
            ...
            # Skip draft/temporary files
            if f.name in {'opus-brand-guidelines.html', 'stitch-preview.html', 'brand-kit.html'}:
                continue
